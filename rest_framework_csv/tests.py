...
class TestCSVRenderer(TestCase):
    ...
    def test_tablize_a_list_with_unicode_elements(self):
        ...
        flat = list(flat)
        self.assertEqual(flat, [["a", "b"], [1, "hello—goodbye"]])
    ...
    def test_render_ordered_rows(self):
        ...
        self.assertTrue(
            ...
            'Failed to override the header. Should be "v3,v1,v2". ' "Was {}".format(dump.split()[0]),
        )
...
class TestCSVParser(TestCase):
    def test_parse_two_lines_flat_csv(self):
        ...
        self.assertEqual(
            data,
            [{"v1": "a", "v2": "1", "v3": "2.3"}, {"v1": "b", "v2": "4", "v3": "5.6"}],
        )
